...
const Question = React.createClass({
  render() {
    ...
    return (
      <div className="question-summary narrow text-primary" id={`question-summary-${id}`}>
        <div className="cp">
        ...
        <div className="summary">
          ...
          <div className="started text-primary">
            <Link to={`/questions/${id}`} className="started-link text-primary">{t('Asked')} <span title={created_at} className="relativetime">{timeAgo(created_at)}</span></Link>&nbsp;

    ...
    return (
      ...
      <div className="panel-body">
        ...
        <div style={{ paddingLeft: '65px' }} className="padding-top-10">
          <Tags data={tags} />
          <div className="padding-top-10 share-block">
          <a className="text-primary" href="#"><h5>{t('Share')}</h5></a>
          <a className="text-success" href="#"><h5>{t('Report')}</h5></a></div>
        </div>
        ...
        <h1 className="text-danger">{t('Answers')}</h1>
        ...
        <b className="text-success"><h2>{t('Add Answer')}:</h2></b>
        ...
        <form className={auth.loggedIn() ? '' : 'hide'} name="answers" action="answers" method="post" onSubmit={this.handleSubmit}>
            ...
            <br/>
            <b className="text-primary">{t('Message')} </b>
            <br/> <br/>
            <textarea onChange={this.onChangeAnswer} ref="message" name="message" required="required"></textarea><br />
            <hr className="light" />
                <br/>		

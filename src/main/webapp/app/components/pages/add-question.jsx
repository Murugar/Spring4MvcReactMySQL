    ...
    render() {
      ...
      return (
        ...
        <div className="panel-body">
          ...
          <h1 className="text-primary">{t('Add a Question')}</h1>
            <form onSubmit={this.handleSubmit}>
              ...
              <input 
                ...
                placeholder={t('Type tag')} /> <a href="javascript:void(0);" className="text-danger" onClick={this.addNewTag}>{t('Add new tag')}</a>
              
              <TagsVariants onAddNewTag={this.onAddNewTag} data={this.state.findedTags} />
              <SelectedTags onTagClick={this.onTagClick} data={tags} />
              <br />
              <button className="btn btn-danger btn-lg" type="submit">{t('Add Question')}</button>
              {this.state.error && (
